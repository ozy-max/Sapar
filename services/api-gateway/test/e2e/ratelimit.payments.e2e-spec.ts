...
const IDENTITY_PORT = 19121;
const TRIPS_PORT = 19122;
const PAYMENTS_PORT = 19123;
const REDIS_TEST_URL = 'redis://127.0.0.1:6379/1';
const PAYMENTS_RPM = 3;
...
beforeAll(() => {
  ...
  process.env['RATE_PAYMENTS_RPM'] = String(PAYMENTS_RPM);
...
describe('Rate Limit — Payments', () => {
  ...
  it('returns 429 with correct body after exceeding limit', async () => {
    for (let i = 0; i < PAYMENTS_RPM; i++) {
